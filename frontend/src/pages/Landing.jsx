...
const Landing = () => {
  ...
  const floatingIcons = [
    ...
    { icon: "⚙️", size: "text-3xl", delay: 4, duration: 8 },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-900 to-green-900 relative overflow-hidden text-gray-100">
      ...
      <motion.header 
        ...
        className="bg-black/20 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-white/10"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            >
              ...
              <h1 className="text-2xl font-bold text-white tracking-tight select-text">
                AI Workspace
              </h1>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-white/10 px-4 py-2 rounded-full mb-6 border border-white/20 backdrop-blur-sm"
            >
              <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
              <span className="text-sm text-green-200">AI-Powered Platform</span>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight select-text" style={{ textShadow: '0 0 20px #06B6D4, 0 0 40px #06B6D4' }}>
              AI-Integrated Health Assessment Web Application
            </h1>
            <div className="text-xl md:text-2xl font-semibold text-slate-200 mb-8">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-slate-200 max-w-3xl mx-auto mb-10 leading-relaxed"
          >
            Upload medical datasets, train AI models for health assessments, integrate Rasa NLU for symptom analysis, and generate accurate predictions —
            all in one seamless, beautifully designed workflow.
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/register"
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-2xl transition shadow-blue-500/25 inline-flex items-center space-x-2 backdrop-blur-sm"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/features"
                className="border-2 border-white/20 hover:border-white/40 text-white px-8 py-4 rounded-xl text-lg font-semibold transition backdrop-blur-sm inline-flex items-center space-x-2 hover:bg-white/5"
              >
            ...
            {stats.map((stat, index) => (
              ...
              >
                <motion.div
                  ...
                  className="text-3xl font-bold text-white mb-2 select-text group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400"
                >
                  {stat.number}
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-200 max-w-2xl mx-auto">
              Everything you need to build, train, and deploy AI models for health assessments in one platform.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="relative bg-black/40 backdrop-blur-sm p-6 rounded-2xl border border-white/10 group-hover:border-white/20 transition-all duration-300 h-full flex flex-col">
                  <motion.div
                    ...
                    className={`w-12 h-12 rounded-xl mb-4 bg-gradient-to-br ${feature.color} flex items-center justify-center text-xl font-semibold shadow-lg`}
                  >
                    {feature.icon}
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="h-0.5 bg-gradient-to-r from-transparent via-white/30 to-transparent mt-4"
                  />
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <div className="relative bg-black/40 backdrop-blur-sm border border-white/10 rounded-2xl p-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 select-text">
                Ready to Start Assessing?
              </h2>
              <p className="text-lg md:text-xl text-slate-200 mb-8 max-w-2xl mx-auto">
                Join healthcare professionals creating intelligent health assessments with our AI platform.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              >
                <Link
                  to="/register"
                  className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-2xl transition shadow-blue-500/25"
                >
                  Get Started
                </Link>
                <Link
                  to="/features"
                  className="border-2 border-white/20 hover:border-white/40 text-white px-8 py-4 rounded-xl text-lg font-semibold transition backdrop-blur-sm hover:bg-white/5"
                >
                  View All Features
                </Link>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-slate-400 max-w-md mx-auto">
              Empowering healthcare with AI-driven assessments and predictions.
            </p>
          </motion.div>
